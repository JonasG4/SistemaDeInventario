...
import { deleteCategoria } from "../../../store/categorias";
...
export default function RegistroUsuarios(props) {
  ...
  async function removeCategeria(id) {
    return dispatch(deleteCategoria(id)).then(() => setShowModal(false));
  }
  return (
    <>
        ...
        >
          ...
          <div className="flex justify-between my-5">
            ...
            <button
              ...
              onClick={() => removeCategeria(props.id)}
            >
              Si, eliminar.
            </button>
          </div>
